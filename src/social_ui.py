...
class SocialInteractionUI:
    ...
    def __init__(self):
        ...
        # Layout constants
        self.bottom_panel_height = int(SCREEN_HEIGHT * 0.18)
        self.right_panel_width = int(SCREEN_WIDTH * 0.18)
        self.bottom_panel_y = SCREEN_HEIGHT - self.bottom_panel_height
    ...
    def show(self, npc, options_with_deltas: list[dict]):
        ...
        options_with_deltas : list[dict]
            List of {"label": str, "action": str, "deltas": list[ReputationDelta]}
        """
        if self._visible:
    ...
    def _draw_option_button(self, screen: pygame.Surface, idx: int, opt: dict,
        ...
        # Label
        font = pygame.font.SysFont("arial", 12, bold=is_selected)
